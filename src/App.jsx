...
import { ProtectedRoute, ProtectedRoutePDV } from './components/ProtectedRoute';
...
import MovimentoPDV from './pages/MovimentoPDV';
    ...
    <AuthProvider>
      <Router>
        <Routes>
          ...
          <Route path="/pdv/painelPdv" element={<ProtectedRoutePDV><PainelPdv /></ProtectedRoutePDV>} />
          <Route path="/pdv/pontodevenda" element={<ProtectedRoutePDV><PontoDeVenda /></ProtectedRoutePDV>} />
          <Route path="/pdv/produtos" element={<ProtectedRoutePDV><ProdutosPdv /></ProtectedRoutePDV>} />
          <Route path="/pdv/configurar-recibo" element={<ProtectedRoutePDV><ConfigurarRecibo /></ProtectedRoutePDV>} />
          <Route path="/pdv/vendas" element={<ProtectedRoutePDV><VendasPDV /></ProtectedRoutePDV>} />
          <Route path="/movimento-pdv" element={<ProtectedRoutePDV><MovimentoPDV /></ProtectedRoutePDV>} />
        </Routes>
      </Router>
    </AuthProvider>
  );
